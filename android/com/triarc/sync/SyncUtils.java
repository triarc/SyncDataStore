...
public class SyncUtils {
	...
	public static String GetWebApiPath(Context context){
		return PreferenceManager.getDefaultSharedPreferences(context).getString(APIPATH_NAME, null);
	}
	public static void SetWebApiPath(Context context, String webApiPath){
		PreferenceManager.getDefaultSharedPreferences(context).edit().putString(APIPATH_NAME, webApiPath).commit();
	}
	/**
	 ...
	 *            Context
	 */
	public static void CreateSyncAccount(Context context, String cookie) {
		...
		accountManager.setPassword(account, cookie);
	...
	public static void DeleteAccount(Context context) {
		...
		PreferenceManager.getDefaultSharedPreferences(context).edit()
		.putBoolean(PREF_SETUP_COMPLETE, false).commit();
		Account account = GenericAccountService.GetAccount();
		AccountManager accountManager = (AccountManager) context
				.getSystemService(Context.ACCOUNT_SERVICE);
